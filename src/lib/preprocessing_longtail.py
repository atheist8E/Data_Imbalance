...
def set_args():
	...
	parser.add_argument("--target_path",      type = str,   default = "C:\\Users\\atheist8E\\Documents\\Satyagraha5\\Earth\\Vanellope\\Dataset\\CIFAR_Custom\\CIFAR10_LT_100\\Train\\")
...
if __name__ == "__main__":
	...
	for i, label in enumerate(labels):
		num_images = round(args.n_base * (mu ** i))
